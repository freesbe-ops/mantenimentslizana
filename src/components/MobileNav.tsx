  ...
  return (
    <div ref={rootRef} className="show-mobile" style={{ display: 'none', position: 'relative', flex: 1 }}>
      <nav style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-evenly', width: '100%', padding: '4px 0' }}>
        ...
        {/* WHATSAPP — opció més a la dreta */}
        <a
          href={waHeader}
          target="_blank"
          rel="noopener noreferrer"
          style={{ ...navItemStyle, color: '#25D366' }}
          onClick={() => { console.log('Clic a WhatsApp header mobile'); ;(window as any).gtag?.('event', 'whatsapp_click', { 'event_category': 'WhatsApp', 'event_label': 'header_mobile' }); ;(window as any).gtag?.('event', 'conversion', { 'send_to': 'AW-18273495657/JRRlCLet-eMcEOnUvYlE' }) }}
        >

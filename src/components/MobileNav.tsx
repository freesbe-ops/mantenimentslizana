...
const SERVICES_ICONS = [
  <svg key="rep" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
...
export default function MobileNav({ currentLang, waHeader, isHome = false }: MobileNavProps) {
  ...
  return (
    <div ref={rootRef} className="show-mobile" style={{ display: 'none', position: 'relative', flex: 1 }}>
      <nav style={{ display: 'flex', gap: 2, alignItems: 'center', justifyContent: 'center', padding: '4px 0' }}>
        ...
        >
          ...
          <span style={{ ...navLabelStyle, color: '#25D366' }}>{t('nav.contacte')}</span>
        </a>
